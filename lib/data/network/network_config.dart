...
class NetworkConfig {
  ...
  static const String CARTS_UPDATE_QUANTITY =
      URL_SERVER + "/carts/update/change-quantity";
  ...
  static const String CARTS_ADD_TO_CART =
      URL_SERVER + "/shoppingcart/add_to_cart";
  ...
  static const String ORDER_LIST_HISTORY =
      URL_SERVER + "/order/transaction-history";
  ...
  static const String ORDER_LIST_REQUEST_DELIVERY =
      URL_SERVER + "/order-package/request-delivery";
  ...
  static const String ORDER_LIST_STATUS =
  ...
  static const String WALLET_TRANSACTION_TYPE =
      URL_SERVER + "/transaction-type";
  static const String WALLET_LIST_TRANSACTION_TYPE =
      URL_SERVER + "/transactions/transaction-type";
  static const String WALLET_TRANSACTION_STATUS =
      URL_SERVER + "/transactions/transaction-status";

  //Profile
  static const String PROFILE_INFO = URL_SERVER + "/auth/me";
  static const String PROFILE_EDIT = URL_SERVER + "/users/update";
  static const String PROFILE_UPLOAD_IMAGE =
      URL_SERVER + "/users/upload-avatar";
  static const String UPLOAD_IMAGE = URL_SERVER + "/uploads/image";
  static const String PROFILE_CHANGE_PASSWORD =
      URL_SERVER + "/users/change-password";
  ...
  static const String PROFILE_DELETE_BANK_LINKED =
      URL_SERVER + "/bank/linked-bank/delete";
  static const String PROFILE_ADD_BANK_LINKED =
      URL_SERVER + "/bank/linked-bank/create";

  //Complaint
  static const String COMPLAINT_LIST = URL_SERVER + "/contacts";
  static const String COMPLAINT_LIST_ANOTHER_REASON =
      URL_SERVER + "/contacts/list-another-reason";
  static const String COMPLAINT_LIST_REASON =
      URL_SERVER + "/contacts/list-reason";
  static const String COMPLAINT_LIST_STATUS =
      URL_SERVER + "/contacts/list-status";
  ...
  static const String DELIVERY_LIST_STATUS =
      URL_SERVER + "/delivery/list-status";
  ...
  static const String PARCEL_LIST_DELIVERY_STORE =
      URL_SERVER + "/delivery/store";
  static const String PACKAGE_LIST_STATUS =
      URL_SERVER + "/order-package/list-status";

  //Consignment
  static const String CONSIGNMENT_LIST = URL_SERVER + "/order-checkins/";
  static const String CONSIGNMENT_CREATE =
      URL_SERVER + "/order-checkins/create";
  static const String CONSIGNMENT_LIST_STATUS =
      URL_SERVER + "/order-checkins/list-status-code";
  ...
  //Chat
  static const String Create_Conversation =
      URL_SERVER + "/admin/chat/create-conversation";
  static const String Get_Conversation =
      URL_SERVER + "/admin/chat/get-conversation";
  ...
  static const String SETTING_TRANSPORT_FORM =
      URL_SERVER + "/admin/setting/transport-form/list";

  //Find_User
  static const String FIND_USER = URL_SERVER + "/admin/order/find-user";
  //EnterWarehouse
  static const String ENTER_WAREHOUSE =
      URL_SERVER + "/admin/order/import-storage";
  //Ramdom Bill Order
  static const String RAMDOM_BILL_ORDER =
      URL_SERVER + "/admin/order/random-bill-code";

  // order admin ownerless
