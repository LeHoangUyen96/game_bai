...
class DataListOrderAddBagResponse {
  ...
  DataListOrderAddBagResponse.fromJson(Map<String, dynamic> json) {
    ...
    this.packing_form =
        json["packing_form"] != null ? json["packing_form"].toString() : '';
    this.surcharge = ParseNumber.parseDouble(json['surcharge']);
    this.isCheck = false;
    this.number_order = 0;
    this.number_package_in_bags = json["number_package_in_bags"] == null
        ? <DataNumberPackageInBags>[]
        : json['number_package_in_bags']
            .map<DataNumberPackageInBags>(
                (e) => DataNumberPackageInBags.fromJson(e))
            .toList();
  }
}
