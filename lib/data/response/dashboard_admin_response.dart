...
class DashboardAdminResponse {
  ...
  DashboardAdminResponse.fromJson(Map<String, dynamic> json) {
    ...
    this.role_name =
        json["role_name"] != null ? json["role_name"].toString() : '';
    this.exchange_rate =
        json["exchange_rate"] != null ? json["exchange_rate"].toString() : '';
    this.order_waits = json["order_waits"] == null
        ? <DataOrderWaits>[]
        : json['order_waits']
            .map<DataOrderWaits>((e) => DataOrderWaits.fromJson(e))
            .toList();
    this.order_closes = json["order_closes"] == null
        ? <DataOrderCloses>[]
        : json['order_closes']
            .map<DataOrderCloses>((e) => DataOrderCloses.fromJson(e))
            .toList();
    this.orders = json["orders"] == null
        ? <DataTotalOrder>[]
        : json['orders']
            .map<DataTotalOrder>((e) => DataTotalOrder.fromJson(e))
            .toList();
  }
}
...
class DataOrderCloses {
  ...
  DataOrderCloses.fromJson(Map<String, dynamic> json) {
    ...
    this.number_package = ParseNumber.parseInt(json['number_package']);
    this.number_package_remain =
        ParseNumber.parseInt(json['number_package_remain']);
    this.number_package_moved =
        ParseNumber.parseInt(json['number_package_moved']);
