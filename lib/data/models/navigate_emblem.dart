...
List<NavigateEmblem> navigateItem = <NavigateEmblem>[
  ...
  NavigateEmblem(NAV_NOTIFICATION, IC_NAV_NOTIFICATION, DISABLED_COLOR, 3, 0, false),
];
class NavigateEmblemAdmin {
   NavigateEmblemAdmin(this.title, this.image, this.color, this.id, this.badgeCount, this.showBadge);
   String title;
   String image;
   Color color;
   int id;
