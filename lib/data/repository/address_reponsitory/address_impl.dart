...
class AddressImpl extends GetConnect implements AddressRepository {
  ...
  Future<List<DataAddress>> onGetAddress() async {
    ...
    if(responseJson.statusCode! >= 200 && responseJson.statusCode! < 300){
      return (responseJson.body['data'] as List).map((e) => DataAddress.fromJson(e)).toList();
    }
  ...
  Future<List<DataCity>> onGetCity() async {
    ...
    final responseJson = await get(url, headers: header);
    if(responseJson.statusCode! >= 200 && responseJson.statusCode! < 300){
      return (responseJson.body['data'] as List).map((e) => DataCity.fromJson(e)).toList();
    }
    throw Exception(responseJson.body['message']);
  }
  ...
  Future<List<DataDistrict>> onGetDistric(int id) async {
    ...
    final responseJson = await get(url, headers: header);
    if(responseJson.statusCode! >= 200 && responseJson.statusCode! < 300){
      return (responseJson.body['data'] as List).map((e) => DataDistrict.fromJson(e)).toList();
    }
    throw Exception(responseJson.body['message']);
  }
  ...
  Future<List<DataWards>> onGetWards(int id) async {
    ...
    final responseJson = await get(url, headers: header);
    if(responseJson.statusCode! >= 200 && responseJson.statusCode! < 300){
      return (responseJson.body['data'] as List).map((e) => DataWards.fromJson(e)).toList();
    }
    throw Exception(responseJson.body['message']);
  }

  @override
  Future<RegisterAddressResponse> onRegisterAddress(AddressRequest request) async {
    final header = NetworkConfig.onBuildHeader();
  ...
  @override
  Future<RegisterAddressResponse> onUpdateAddress(AddressRequest request, int id) async {
    final header = NetworkConfig.onBuildHeader();
