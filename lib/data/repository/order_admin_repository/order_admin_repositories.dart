...
abstract class OrderAdminRepositories {
  ...
  Future<ListStatusResponse> onGetListStatus();
  Future<OrderAdminResponse> onGetListOrderProcedure();
  Future<OrderAdminResponse> onGetListOrderCN();
  Future<OrderAdminResponse> onGetListOrderHN();
  Future<OrderAdminResponse> onGetListOrderSG();
  Future<OrderAdminResponse> onGetListOrderBorder();
  Future<OrderAdminResponse> onGetListOrderReceive();
  Future<OrderAdminResponse> onGetListOrderDelivery();
  Future<OrderAdminResponse> onGetListOrderDN();
  Future<ForgotPassResponse> onUpdateFeeWarhouseVN(
      UpdateFeeWarhouseVN request, String id);
}
