  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<OrderInventoryListController>(
        ...
        builder: (value) => Scaffold(
              ...
              bottomNavigationBar: controller.orderResponse != null
                  ? _buildBottomNav()
                  : Container(),
            ));
  }
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: controller.orderResponse!.data!.length != 0
                      ? Row(
                          children: [
                            Container(
                              width: 5.0.w,
                              ...
                              child: Icon(
                                Icons.check,
                                size: 4.0.w,
                                color: controller.selectedAll == true
                                    ? MAIN_COLOR
                                    : Colors.white,
                                //color: MAIN_COLOR
                              ),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        ...
                        size: 4.0.w,
                        color:
                            data.selected == true ? MAIN_COLOR : Colors.white,
                        //color:  MAIN_COLOR ,
                      ),
                    ),
                  ),
        ...
        onTap: () {
          for (var i = 0; i < controller.orderResponse!.data!.length; i++) {
            if (controller.orderResponse!.data![i].selected == true) {
              controller.listOrderId
                  .add(controller.orderResponse!.data![i].id!);
            }
          }
          Get.dialog(PackingOrderWidget(
            listOrderId: controller.listOrderId,
          )).then((value) {
            if (value != null) {
