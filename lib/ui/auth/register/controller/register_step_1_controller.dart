...
class RegisterStepOneController extends GetxController  implements RegisterContract{
  ...
  void onResgiterStep1() {
    ...
    if (isEmailValid && isPhoneNumberValid && isNameValid ) {
      ...
      _authRepository.onRegisterStep1(_request, NetworkConfig.REGISTER_STEP_1).then((value) {
