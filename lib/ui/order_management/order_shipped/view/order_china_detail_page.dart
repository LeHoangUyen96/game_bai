...
import 'package:viet_trung_mobile_admin/ui/order_management/order_shipped/controller/order_china_detail_controller.dart';
import 'package:viet_trung_mobile_admin/ui/order_management/order_shipped/view/item_images_order_cn.dart';
...
class OrderChinaDetailPage extends GetView<OrderChinaDetailController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<OrderChinaDetailController>(
      init: OrderChinaDetailController(),
