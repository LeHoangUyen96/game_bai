...
import 'package:viet_trung_mobile_admin/ui/order_management/order_no_transport/controller/order_not_shipped_controller.dart';
import 'package:viet_trung_mobile_admin/ui/order_management/order_no_transport/view/order_no_transport_detail_page.dart';
import 'package:viet_trung_mobile_admin/widget/header_order._page.dart';
import 'package:viet_trung_mobile_admin/widget/text_customized.dart';

class OrderNotShippedPage extends GetView<OrderNoTransportController> {
  @override
        ...
        children: [
          ...
          SingleChildScrollView(
            child: ListView.builder(
              itemCount: controller.orderNotTranport!.data!.length,
              shrinkWrap: true,
              physics: NeverScrollableScrollPhysics(),
              itemBuilder: (BuildContext context, int index) {
                return _buildListOrder(
                    controller.orderNotTranport!.data![index]);
              },
            ),
          ),
          SizedBox(height: 15),
