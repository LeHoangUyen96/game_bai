  ...
  Widget build(BuildContext context) {
    return GetBuilder<DashboardAdminController>(
        ...
        builder: (value) => Scaffold(
              body: controller.dashboardAdminResponse != null
                  ? _buildBody()
                  : LoadingSpinKit(),
            ));
  }
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              TextCustomized(
                                text: controller.dashboardAdminResponse!.name
                                    .toString(),
                                color: WHITE,
                                size: normalSize,
                              ...
                              TextCustomized(
                                text: controller
                                    .dashboardAdminResponse!.role_name
                                    .toString(),
                                color: WHITE,
                                size: smallSize,
                          ...
                          children: [
                            Container(
                              ...
                              child: TextCustomized(
                                text: "Tỷ giá: " +
                                    ParseNumber.parseInt(controller
                        ...
                        child: ListView.separated(
                          itemBuilder: (BuildContext context, int index) {
                            return _builListItem(controller
                                .dashboardAdminResponse!.order_closes![index]);
                          },
                          shrinkWrap: true,
                          ...
                          itemCount: controller
                              .dashboardAdminResponse!.order_closes!.length,
                          padding: EdgeInsets.all(0.0),
                        ),
                      ),
                    ]))
        ...
        children: [
          Row(
            ...
            children: [
              InkWell(
                onTap: () {
                  Get.to(OrderShipBackDetailPage(),
