...
import 'package:viet_trung_mobile_admin/ui/admin/manager_staff/view/create_staff_page.dart';
import 'package:viet_trung_mobile_admin/ui/admin/manager_staff/view/detail_staff_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ManagerStaffController>(
      ...
      builder: (value) => Scaffold(
        ...
        appBar: buildAppBar(),
        body: controller.listAdminResponse != null
            ? buildBody()
            : LoadingSpinKit(),
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      return __buildItemStaff(
                          controller.listAdminResponse!.data![index]);
                    },
                    shrinkWrap: true,
