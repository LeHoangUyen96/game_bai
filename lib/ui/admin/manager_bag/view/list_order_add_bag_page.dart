...
import 'package:viet_trung_mobile_admin/ui/admin/manager_bag/view/item_order_add_to_bag.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ListOrderAddToBagController>(
        ...
        builder: (value) => Dialog(
              ...
              child: controller.listOrderAddBagResponse != null
                  ? GestureDetector(
                      onTap: () {
                              ...
                              child: Container(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemCount: controller
                                      .listOrderAddBagResponse!.data!.length,
