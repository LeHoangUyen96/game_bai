                            ...
                            child: Column(
                              children: [
                                Wrap(spacing: 2.0, children: [
                                  TextCustomized(text: "Đơn hàng mã"),
                                  TextCustomized(
                                    text: "#" +
                                        controller.orderDetailsResponse!
                                            .dataOrderDetails!.bill_code
                                            .toString(),
                                    color: COLOR_ORDER_CHINESE_WAREHOUSE,
                                  ),
                                  TextCustomized(
                                      text:
                                          "đã về Kho Trung Quốc. Vui lòng xác nhận và chọn 1 trong 2 phương án sau:"),
                                ]),
                                Column(
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              TextCustomized(
                  text: "Địa chỉ nhận hàng", weight: FontWeight.w700),
              SizedBox(height: 5),
              Container(
                    ...
                    children: [
                      Expanded(
                        child: DropdownButtonHideUnderline(
                            child: controller.mdataAddress != null
                                ? DropdownButton(
                                    value: controller.selectAddress != null
